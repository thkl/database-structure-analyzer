...
class SVGDiagramGenerator {
  ...
  calculateTableWidths() {
    for (const table of this.tables) {
      ...
      const titleWidth = this.estimateTextWidth(displayName, this.options.headerFontSize) + this.options.textPadding;
      ...
      for (const column of visibleColumns) {
        ...
        const columnWidth = this.estimateTextWidth(fullColumnText, this.options.fontSize) + this.options.textPadding;
      ...
      if (table.columns.length > this.options.maxColumns) {
        ...
        const moreWidth = this.estimateTextWidth(moreText, this.options.fontSize) + this.options.textPadding;
